    ...
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-8">
          <Link 
            href="/input" 
            className="text-blue-500 hover:text-blue-700 text-lg font-medium inline-block mb-4"
          >
            ← 入力を修正する
          </Link>
        ...
        {result.daysUntilShortage ? (
          <div className="mb-8 p-6 bg-red-50 border-2 border-red-200 rounded-xl">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-red-800 mb-2">⚠️ 資金ショートの危険性</h2>
              <p className="text-red-700 text-xl font-semibold">
                あと<span className="text-3xl font-bold">{result.daysUntilShortage}</span>日で残高が0円になります
              </p>
              {result.shortageDate && (
          ...
          <div className="mb-8 p-6 bg-green-50 border-2 border-green-200 rounded-xl">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-green-800 mb-2">✅ 資金に余裕があります</h2>
        ...
        {/* 最終残高表示 */}
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          <h3 className="text-xl font-bold text-center mb-4">60日後の予想残高</h3>
        ...
        <div className="mt-8 p-4 bg-yellow-50 rounded-lg">
          <h3 className="font-medium text-yellow-900 mb-2">シミュレーション結果について</h3>
